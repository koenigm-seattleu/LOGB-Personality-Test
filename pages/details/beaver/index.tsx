            ...
            <main className={styles.description}>
                <FadeIn delay={150}>
                    ...
                    <p>
                        ...
                        book. In fact, they are the kind of people who actually
                        read instruction manuals. They are great at providing
                        quality control in an office, and will provide quality
                        control in any situation or field that demands accuracy,
                        such as accounting, engineering, etc. Because rules,
                        consistency and high standards are so important to
                        beavers, they are often frustrated with others who do
                        not share these same characteristics. Their strong need
                        for maintaining high (and oftentimes unrealistic)
                    ...
                    <div className={styles.descriptionColumnsContainer}>
                        ...
                        <p className={styles.descriptionRightContent}>
                            Beavers are good listeners, communicate details, and
                            are usually diplomatic
                        </p>
                    </div>
                    ...
                    <div className={styles.descriptionColumnsContainer}>
                        ...
                        <p className={styles.descriptionRightContent}>
                            The beaver needs security, gradual change and time
                            to adjust to it
                        </p>
                    </div>
                    ...
                    <div className={styles.descriptionColumnsContainer}>
                        ...
                        <p className={styles.descriptionRightContent}>
                            ...
                            risk, and tasks that require precision and planning
                        </p>
                    </div>
                </FadeIn>
            </main>
