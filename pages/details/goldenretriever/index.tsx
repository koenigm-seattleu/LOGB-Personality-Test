            ...
            <main className={styles.description}>
                <FadeIn delay={150}>
                    ...
                    <p>
                        ...
                        pain and punishment in a relationship and still stay
                        committed. They are great listeners, incredibly
                        empathetic and warm encouragers. However, they tend to
                        be such pleasers that they can have great difficulty
                        being assertive in a situation or relationship when it’s
                        needed.
                    </p>
                    ...
                    <div className={styles.descriptionColumnsContainer}>
                        ...
                        <p className={styles.descriptionRightContent}>
                            Desire for good relationships and appreciation of
                            others
                        </p>
                    </div>
                    ...
                    <div className={styles.descriptionColumnsContainer}>
                        ...
                        <p className={styles.descriptionRightContent}>
                            Golden Retrievers focus on the present and devote
                            lots of time to helping others and building
                            relationships
                        </p>
                    </div>
                    ...
                    <div className={styles.descriptionColumnsContainer}>
                        ...
                        <p className={styles.descriptionRightContent}>
                            The Golden Retriever needs security; gradual change
                            and time to adjust to it; an environment free of
                            conflict
                        </p>
                    </div>
                    ...
                    <div className={styles.descriptionColumnsContainer}>
                        ...
                        <p className={styles.descriptionRightContent}>
                            ...
                            environment; a relaxed and friendly environment;
