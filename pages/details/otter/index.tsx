            ...
            <main className={styles.description}>
                <FadeIn delay={150}>
                    ...
                    <p>
                        ...
                        love to talk! They’re great at motivating others and
                        need to be in an environment where they can talk and
                        have a vote on major decisions. The otters’ outgoing
                        nature makes them great networkers — they usually know a
                        lot of people who know a lot of people. They can be very
                        loving and encouraging unless under pressure, when they
                        tend to use their verbal skills to attack. They have a
                        strong desire to be liked and enjoy being the center of
                        attention. They are often very attentive to style,
                        clothes, and flash. Otters are the life of any party;
                        and most people really enjoy being around them.
                    </p>
                    ...
                    <div className={styles.descriptionColumnsContainer}>
                        ...
                        <p className={styles.descriptionRightContent}>
                            Otters focus on the future and have a tendency to
                    ...
                    <div className={styles.descriptionColumnsContainer}>
                        ...
                        <p className={styles.descriptionRightContent}>
                            Intuitive and fast. Makes lots of “right calls” and
                            lots of wrong ones.
                        </p>
                    </div>
