            ...
            <main className={styles.description}>
                <FadeIn delay={150}>
                    ...
                    <p>
                        ...
                        decisive, bottom line folks who are observers, not
                        watchers or listeners. They love to solve problems. They
                        are usually individualists who love to seek new
                    ...
                    <p>
                        ...
                        will. Unfortunately, if they don’t learn how to tone
                        down their aggressiveness, their natural dominating
                        traits can cause problems with others. Most
                        entrepreneurs are strong lions, or at least have a lot
                        of lion in them.
                    </p>
                    ...
                    <div className={styles.descriptionColumnsContainer}>
                        ...
                        <div className={styles.descriptionList}>
                            ...
                            <ul>
                                ...
                                <li>
                                    May &ldquo;run over&rdquo; others who are
                                    slower to act or speak
                                </li>
                    ...
                    <div className={styles.descriptionColumnsContainer}>
                        ...
                        <p className={styles.descriptionRightContent}>
                            Lions focus on NOW instead of distant future. They
                            get a lot more done in a lot less time than their
                            peers. Hate wasting time; and like to get right to
                            the point.
                        </p>
                    </div>
                    ...
                    <div className={styles.descriptionColumnsContainer}>
                        ...
                        <p className={styles.descriptionRightContent}>
                            Impulsive; makes quick decisions with goal or end
                            result in mind. Results-focused. Needs very few
                    ...
                    <div className={styles.descriptionColumnsContainer}>
                        ...
                        <p className={styles.descriptionRightContent}>
                            The lion needs to see results, experience variety,
                            and face new challenges. He needs to solve problems
                            and wants direct answers.
                        </p>
                    </div>
